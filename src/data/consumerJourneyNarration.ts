...
export const consumerJourneyNarrations: SlideNarration[] = [
  ...
  },
  {
    ...
    script: `So what actually arrives in your business? One connected platform with six solutions. Ava — your AI analyst, working across all of them. Analyst-validated data, refreshed continuously. Named domain experts embedded in your team. A ninety-day onboarding that maps the platform to your categories. And quarterly executive briefings, ready for your board. Live in ninety days. Renewed annually. Advisory included. That's what you're buying. Now let's see it in action.`,
    voiceId: DEFAULT_VOICE_ID,
  },
  {
    slideId: 7,
