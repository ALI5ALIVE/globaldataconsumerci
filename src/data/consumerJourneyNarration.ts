...
export const consumerJourneyNarrations: SlideNarration[] = [
  ...
  },
  {
    ...
    script: `Imagine seeing that same opportunity through one connected lens. Five solutions \u2014 each best-in-class \u2014 working together for the first time. Sarah, your Head of Strategy, uses Strategic Intelligence to spot emerging disruptions and converging themes \u2014 giving you predictive foresight before the market shifts. James gets one definitive sizing from Market Intelligence across every market you care about. Priya tracks every competitive move in real time. Marcus tests concepts against real evidence with Innovation Intelligence. And Elena walks into every buyer meeting armed with the full story from Sales Intelligence. Connecting all of them is Ava \u2014 our AI intelligence layer \u2014 surfacing patterns no single team would spot alone. David wraps it into one contract at thirty percent lower cost. Six people. One platform. That\u2019s what Connected Intelligence is. Now let\u2019s see how it works in practice.`, seeing that same opportunity through one connected lens. Five solutions — each best-in-class — working together for the first time. Sarah, your Head of Strategy, uses Strategic Intelligence to spot emerging disruptions and converging themes — giving you predictive foresight before the market shifts. James gets one definitive sizing from Market Intelligence across every market you care about. Priya tracks every competitive move in real time. Marcus tests concepts against real evidence with Innovation Intelligence. And Elena walks into every buyer meeting armed with the full story from Sales Intelligence. Connecting all of them is Ava — our AI intelligence layer — surfacing patterns no single team would spot alone. David wraps it into one contract at thirty percent lower cost. Six people. One platform. That's what Connected Intelligence is. Now let's see how it works in practice.`,. James gets one definitive sizing from Market Intelligence across every market you care about. Priya tracks every competitive move in real time. Marcus tests concepts against real evidence with Innovation Intelligence. And Elena walks into every buyer meeting armed with the full story from Sales Intelligence. Connecting all of them is Ava — our AI intelligence layer — surfacing patterns no single team would spot alone. David wraps it into one contract at thirty percent lower cost. Six people. One platform. That's what Connected Intelligence is. Now let's see how it works in practice.`,
    voiceId: DEFAULT_VOICE_ID,
  },
  {
    slideId: 5,
