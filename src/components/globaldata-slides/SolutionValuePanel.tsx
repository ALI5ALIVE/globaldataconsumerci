...
const SolutionValuePanel = ({ activeSolution }: SolutionValuePanelProps) => {
  ...
  if (!deepDive) {
    return (
      <div className="h-full min-h-[150px] max-h-[300px] flex items-center justify-center bg-card/30 border border-border/30 rounded-xl p-4">
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div 
        ...
        className="h-full min-h-[150px] max-h-[300px] bg-card/50 border rounded-xl p-3 overflow-y-auto"
