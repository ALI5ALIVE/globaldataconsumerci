...
const SolutionValuePanel = ({ activeSolution }: SolutionValuePanelProps) => {
  ...
  if (!deepDive) {
    return (
      <div className="h-full min-h-[200px] max-h-[380px] flex items-center justify-center bg-card/30 border border-border/30 rounded-xl p-4">
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div 
        ...
        className="h-full min-h-[200px] max-h-[380px] bg-card/50 border rounded-xl p-4 overflow-y-auto"
