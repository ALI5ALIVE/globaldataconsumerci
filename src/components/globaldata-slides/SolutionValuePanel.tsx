...
const SolutionValuePanel = ({ activeSolution }: SolutionValuePanelProps) => {
  ...
  if (!deepDive) {
    return (
      <div className="h-full min-h-[120px] max-h-[260px] flex items-center justify-center bg-card/30 border border-border/30 rounded-xl p-3">
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div 
        ...
        className="h-full min-h-[120px] max-h-[260px] bg-card/50 border rounded-xl p-2 overflow-y-auto"
