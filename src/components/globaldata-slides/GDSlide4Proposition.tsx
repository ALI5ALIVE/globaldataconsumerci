    ...
    >
      <div className="flex flex-col gap-1.5 h-full max-h-full overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-primary/10 to-sky-500/5 border border-primary/30 rounded-xl p-2">
          <p className="text-xs md:text-sm font-medium text-foreground leading-relaxed text-center">
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-2 items-center min-h-0 max-h-[calc(100%-80px)]">
          {/* Connected Intelligence Wheel */}
          <div className="flex items-center justify-center h-full max-h-[280px]">
