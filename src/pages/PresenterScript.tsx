...
const slides: ScriptSlide[] = [
  ...
  },
  {
    ...
    timing: "2:13",
    paragraphs: [
      "It's still Monday. Same nine a.m., same forty-one minutes in, same CEO email about plant-based protein — but this time the seven inboxes collapse into one connected lens. Five intelligence solutions, one shared taxonomy, forty years of analyst-validated data — and Ava, your AI layer, sitting across all of it. Ava doesn't replace your team. She does the work between them: spotting the pattern that crosses two solutions, flagging the signal before anyone asks, drafting the first answer so your people start at minute thirty, not minute zero. Here's what that means for the people on your team.",
      "Sarah in Strategy stops chasing convergence across vendors — no more 'strategy says peaking, social says accelerating'; she sees one score, across twenty-two sectors. Chloe in Market Sizing stops rebuilding TAMs in spreadsheets — no more two finance numbers; the market is already sized and forecast across a hundred and ten countries. Sebastian in Competitive Intelligence stops finding out late — the four-patent surprise from Monday's inbox doesn't happen anymore; twenty-five thousand companies, every move tracked the day it happens. Priya in Innovation stops guessing at concepts — four million products and patents tell her what's already been tried and what's about to land. Marcus in Commercial stops walking into retailers with caveats — he walks in with the evidence, account by account. And David in Procurement stops managing fourteen overlapping contracts — one platform, one contract, total cost of ownership down forty percent.",
      "One platform. One source of truth. Every number traceable back to a named analyst — and Ava connecting the dots none of them would have time to spot alone. Now it's Friday — same week, same question, same CEO. Watch what they do with it.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ava reads the question, pulls the relevant signal from each of the five solutions, and posts a draft answer to the room before the meeting starts. Each person walks in to their own view, already populated, already cross-referenced. They're not gathering data — they're pressure-testing it.",
      "Sarah on Strategy — convergence score ninety-two out of a hundred: every long-range signal she tracks, from health to sustainability to protein anxiety, is pointing the same way. Chloe on Market Sizing — a two-point-one billion dollar TAM growing at eleven percent compound, and Southeast Asia is the white space inside it: Indonesia, Vietnam, the Philippines — none of the global brands have moved yet. Sebastian on Competitive — threat level high: a regional rival is already building manufacturing capacity, four patents filed in the last ninety days — the same four that ambushed the inbox on Monday, only this time Sebastian flagged the first filing in week one, and caught the supplier shift two weeks before trade press did. Priya on Innovation — three of your five existing concepts already pass against the converging trends, so you don't need a clean-sheet R&D programme; you need to accelerate what's already in the pipeline. Marcus on Commercial — two of three target retailers have a first-mover slot open in their next category review, and his account history says they'll listen if you bring the evidence. And David on Procurement — one contract sits behind every number on this slide, not fourteen, so the answer itself costs less than last quarter's reconciliation bill.",
      "Same taxonomy, so the numbers reconcile automatically. Ava attaches a confidence score and a citation to every figure — you can click the GO verdict back to the source survey, the patent filing, the shipment record. Old way: seven vendors, fourteen weeks, three conflicting answers. New way: one platform, one meeting, Ava-assembled, human-decided. Monday's clock that 'started now' — it stopped on Friday at minute forty-seven, with every line traceable to source.",
    ],
